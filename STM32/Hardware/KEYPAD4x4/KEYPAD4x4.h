...
#define KEY2	GPIO_Pin_7	//定义IO接口
#define KEY3	GPIO_Pin_8	//定义IO接口
#define KEY4	GPIO_Pin_9	//定义IO接口
#define KEYa	GPIO_Pin_10	//定义IO接口
#define KEYb	GPIO_Pin_11//定义IO接口
#define KEYc	GPIO_Pin_12//定义IO接口
